...
public class modifyArchiveTask extends JDialog {
    private MainFrame mainFrame;
    private Archive archive;
    private Task oldtask;

    public modifyArchiveTask(Archive archive, Task oldtask, MainFrame mainFrame) {
    ...
    public JPanel initComponents() {
        ...
        JLabel pageTitleLb = new JLabel("Modify archived task :");
        ...
        Component[] grpJLB = { descriptionLb, deadlineLb, thematicLb, archiveDateLb, archivedByLb };
        ...
        JSpinner archiveDateSpinner = new DateTimeSpinner(oldtask.getDateArchive());
        ...
        ArchivedByComboBox.setSelectedItem(oldtask.getArchiveBy());
            ...
            public void actionPerformed(ActionEvent e) {
                    ...
                    for (Task task : taskList) {
                        if (task.getDescription().toString().toLowerCase()
                                ...
                                && !task.getDescription().toString().toLowerCase()
                                        .equals(oldtask.getDescription().toLowerCase())) {
                            condition = true;
                        } else {
                            indice++;
                        }
                ...
                if (condition == true) {
                    ...
                    Task newTask = new Task(0, descriptionTf.getText(), formattedDeadline,
                            oldtask.getDuration().toString(),
                            oldtask.getPriority().toString(),
                            thematicTf.getText(), oldtask.getAssignementBy().toString(),
                            oldtask.getAssignementFor().toString(), true,
                            formattedArchiveDate,
                            ArchivedByComboBox.getSelectedItem().toString());
